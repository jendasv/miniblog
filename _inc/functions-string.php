<?php
    ...
    /**
     *
     * Clear input string from html shit
     *
     * @param $str
     * @return string
     */
  ...
  /*  function word_limiter( $str, $limit = 100, $end_car = '&#8230;' )
    {
        if (trim($str) === '')
        {
            return $str;
        ...
        return rtrim($matches[0]).$end_car;
    }*/
    /**
     * Word Limiter
     *
    ...
    /**
     * Text Comparation Case Sensitive
     *
     * Compare two strings
     * 0    strings are equal
     * > 0  string1 is longer than string2
     * < 0  string1 is shorter than string2
     *
     * @param $string1
     * @param $string2
     * @return int|lt
     */
    function text_compare_cSens( $string1, $string2 )
    {
